...
class EfficientVisionTransformer(VisionTransformer):
    ...
    """
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, global_pool='token', embed_dim=768, depth=12,
        ...
        """
        super().__init__(img_size, patch_size, in_chans, num_classes, global_pool, embed_dim, depth,
                 num_heads, mlp_ratio, qkv_bias, drop_rate=drop_rate, drop_path_rate=drop_path_rate)
...
def _create_efficient_vit(variant, pretrained=False, **kwargs):
