...
from timm.layers import trunc_normal_, AvgPool2dSame, DropPath, Mlp, GlobalResponseNormMlp, \
    LayerNorm2d, LayerNorm, create_conv2d, get_act_layer, get_norm_layer, make_divisible, to_ntuple
...
__all__ = ['AseaConvNeXt']  # model_registry will add each entrypoint fn to this
...
class ConvNeXtBlock(nn.Module):
    ...
    def __init__(
        ...
        if (0 < self.keep_rate <= 1):
            ...
            self.asea_ls = LayerScale2D(out_chs, asea_ls_init_values) if asea_ls_init_values else nn.Identity()
    ...
    def __init__(
        ...
        for loc, kr in zip(reduction_loc, token_ratio):
            ...
            for j, nl in enumerate(depths):
                ...
                res = res_curr % nl
                # check if curr loc is within current depth stage (quotient == 0)
                if quotient_int == 0:
                    ...
                    break
                # or if not move to the next stage: substract current stage layers
                elif quotient_int >= 1:
...
def _create_convnext(variant, pretrained=False, **kwargs):
    ...
    model = build_model_with_cfg(
        AseaConvNeXt, variant, pretrained,
...
default_cfgs = generate_default_cfgs({
    ...
    'asea_convnext_tiny.in12k_ft_in1k': _cfg(
        hf_hub_id='timm/convnext_tiny.in12k_ft_in1k',
        crop_pct=0.95, test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnext_small.in12k_ft_in1k': _cfg(
        hf_hub_id='timm/convnext_small.in12k_ft_in1k',
        crop_pct=0.95, test_input_size=(3, 288, 288), test_crop_pct=1.0),

    'asea_convnext_atto.d2_in1k': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-rsb-weights/convnext_atto_d2-01bb0f51.pth',
        hf_hub_id='timm/convnext_atto.d2_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=0.95),
    'asea_convnext_atto_ols.a2_in1k': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-rsb-weights/convnext_atto_ols_a2-78d1c8f3.pth',
        hf_hub_id='timm/convnext_atto_ols.a2_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=0.95),
    'asea_convnext_femto.d1_in1k': _cfg(
        ...
        test_input_size=(3, 288, 288), test_crop_pct=0.95),
    'asea_convnext_femto_ols.d1_in1k': _cfg(
        ...
        hf_hub_id='timm/convnext_femto_ols.d1_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=0.95),
    'asea_convnext_pico.d1_in1k': _cfg(
    ...
    'asea_convnext_nano_ols.d1h_in1k': _cfg(
        ...
        hf_hub_id='timm/convnext_nano_ols.d1h_in1k',
        crop_pct=0.95, test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnext_tiny_hnf.a2h_in1k': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-rsb-weights/convnext_tiny_hnf_a2h-ab7e9df2.pth',
        hf_hub_id='timm/convnext_tiny_hnf.a2h_in1k',
        crop_pct=0.95, test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnext_nano.r384_in12k_ft_in1k': _cfg(
        hf_hub_id='timm/convnext_nano.r384_in12k_ft_in1k',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0),

    'asea_convnext_tiny.in12k_ft_in1k_384': _cfg(
        hf_hub_id='timm/convnext_tiny.in12k_ft_in1k_384',
       input_size=(3, 384, 384), pool_size=(12, 12),  crop_pct=1.0, crop_mode='squash'),
    'asea_convnext_small.in12k_ft_in1k_384': _cfg(
        hf_hub_id='timm/convnext_small.in12k_ft_in1k_384',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0,  crop_mode='squash'),

    'asea_convnext_nano.in12k': _cfg(
        hf_hub_id='timm/convnext_nano.in12k',
        crop_pct=0.95, num_classes=11821),
    'asea_convnext_nano.r384_in12k': _cfg(
        hf_hub_id='timm/convnext_nano.r384_in12k',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, num_classes=11821),
    'asea_convnext_nano.r384_ad_in12k': _cfg(
        hf_hub_id='timm/convnext_nano.r384_ad_in12k',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, num_classes=11821),
    'asea_convnext_tiny.in12k': _cfg(
        hf_hub_id='timm/convnext_tiny.in12k',
        crop_pct=0.95, num_classes=11821),
    'asea_convnext_small.in12k': _cfg(
        hf_hub_id='timm/convnext_small.in12k',
        crop_pct=0.95, num_classes=11821),

    'asea_convnext_tiny.fb_in22k_ft_in1k': _cfg(
        url='https://dl.fbaipublicfiles.com/convnext/convnext_tiny_22k_1k_224.pth',
        hf_hub_id='timm/convnext_tiny.fb_in22k_ft_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnext_small.fb_in22k_ft_in1k': _cfg(
        url='https://dl.fbaipublicfiles.com/convnext/convnext_small_22k_1k_224.pth',
        hf_hub_id='timm/convnext_small.fb_in22k_ft_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnext_base.fb_in22k_ft_in1k': _cfg(
        url='https://dl.fbaipublicfiles.com/convnext/convnext_base_22k_1k_224.pth',
        hf_hub_id='timm/convnext_base.fb_in22k_ft_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnext_large.fb_in22k_ft_in1k': _cfg(
        url='https://dl.fbaipublicfiles.com/convnext/convnext_large_22k_1k_224.pth',
        hf_hub_id='timm/convnext_large.fb_in22k_ft_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnext_xlarge.fb_in22k_ft_in1k': _cfg(
        url='https://dl.fbaipublicfiles.com/convnext/convnext_xlarge_22k_1k_224_ema.pth',
        hf_hub_id='timm/convnext_xlarge.fb_in22k_ft_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=1.0),

    # kernel 3 and 5 from inceptionnext
    'asea_convnext_tiny_k3.sail_in1k': _cfg(
        url="https://github.com/sail-sg/inceptionnext/releases/download/model/convnext_tiny_k3_1k_224_ema.pth",
        test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnext_tiny_k5.sail_in1k': _cfg(
        url="https://github.com/sail-sg/inceptionnext/releases/download/model/convnext_tiny_k5_1k_224_ema.pth",
        test_input_size=(3, 288, 288), test_crop_pct=1.0),
    # kernel 7
    'asea_convnext_tiny.fb_in1k': _cfg(
        url="https://dl.fbaipublicfiles.com/convnext/convnext_tiny_1k_224_ema.pth",
        hf_hub_id='timm/convnext_tiny.fb_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnext_small.fb_in1k': _cfg(
        url="https://dl.fbaipublicfiles.com/convnext/convnext_small_1k_224_ema.pth",
        hf_hub_id='timm/convnext_small.fb_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnext_base.fb_in1k': _cfg(
        url="https://dl.fbaipublicfiles.com/convnext/convnext_base_1k_224_ema.pth",
        hf_hub_id='timm/convnext_base.fb_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnext_large.fb_in1k': _cfg(
        url="https://dl.fbaipublicfiles.com/convnext/convnext_large_1k_224_ema.pth",
        hf_hub_id='timm/convnext_large.fb_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=1.0),

    'asea_convnext_tiny.fb_in22k_ft_in1k_384': _cfg(
        url='https://dl.fbaipublicfiles.com/convnext/convnext_tiny_22k_1k_384.pth',
        hf_hub_id='timm/convnext_tiny.fb_in22k_ft_in1k_384',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, crop_mode='squash'),
    'asea_convnext_small.fb_in22k_ft_in1k_384': _cfg(
        url='https://dl.fbaipublicfiles.com/convnext/convnext_small_22k_1k_384.pth',
        hf_hub_id='timm/convnext_small.fb_in22k_ft_in1k_384',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, crop_mode='squash'),
    'asea_convnext_base.fb_in22k_ft_in1k_384': _cfg(
        url='https://dl.fbaipublicfiles.com/convnext/convnext_base_22k_1k_384.pth',
        hf_hub_id='timm/convnext_base.fb_in22k_ft_in1k_384',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, crop_mode='squash'),
    'asea_convnext_large.fb_in22k_ft_in1k_384': _cfg(
        url='https://dl.fbaipublicfiles.com/convnext/convnext_large_22k_1k_384.pth',
        hf_hub_id='timm/convnext_large.fb_in22k_ft_in1k_384',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, crop_mode='squash'),
    'asea_convnext_xlarge.fb_in22k_ft_in1k_384': _cfg(
        url='https://dl.fbaipublicfiles.com/convnext/convnext_xlarge_22k_1k_384_ema.pth',
        hf_hub_id='timm/convnext_xlarge.fb_in22k_ft_in1k_384',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, crop_mode='squash'),

    'asea_convnext_tiny.fb_in22k': _cfg(
        url="https://dl.fbaipublicfiles.com/convnext/convnext_tiny_22k_224.pth",
        hf_hub_id='timm/convnext_tiny.fb_in22k',
        num_classes=21841),
    'asea_convnext_small.fb_in22k': _cfg(
        url="https://dl.fbaipublicfiles.com/convnext/convnext_small_22k_224.pth",
        hf_hub_id='timm/convnext_small.fb_in22k',
        num_classes=21841),
    'asea_convnext_base.fb_in22k': _cfg(
        url="https://dl.fbaipublicfiles.com/convnext/convnext_base_22k_224.pth",
        hf_hub_id='timm/convnext_base.fb_in22k',
        num_classes=21841),
    'asea_convnext_large.fb_in22k': _cfg(
        url="https://dl.fbaipublicfiles.com/convnext/convnext_large_22k_224.pth",
        hf_hub_id='timm/convnext_large.fb_in22k',
        num_classes=21841),
    'asea_convnext_xlarge.fb_in22k': _cfg(
        url="https://dl.fbaipublicfiles.com/convnext/convnext_xlarge_22k_224.pth",
        hf_hub_id='timm/convnext_xlarge.fb_in22k',
        num_classes=21841),

    'asea_convnextv2_nano.fcmae_ft_in22k_in1k': _cfgv2(
        ...
        test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnextv2_nano.fcmae_ft_in22k_in1k_384': _cfgv2(
        url='https://dl.fbaipublicfiles.com/convnext/convnextv2/im22k/convnextv2_nano_22k_384_ema.pt',
        hf_hub_id='timm/convnextv2_nano.fcmae_ft_in22k_in1k_384',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, crop_mode='squash'),
    'asea_convnextv2_tiny.fcmae_ft_in22k_in1k': _cfgv2(
        ...
        test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnextv2_tiny.fcmae_ft_in22k_in1k_384': _cfgv2(
        url="https://dl.fbaipublicfiles.com/convnext/convnextv2/im22k/convnextv2_tiny_22k_384_ema.pt",
        hf_hub_id='timm/convnextv2_tiny.fcmae_ft_in22k_in1k_384',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, crop_mode='squash'),
    'asea_convnextv2_base.fcmae_ft_in22k_in1k': _cfgv2(
        ...
        test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnextv2_base.fcmae_ft_in22k_in1k_384': _cfgv2(
        url="https://dl.fbaipublicfiles.com/convnext/convnextv2/im22k/convnextv2_base_22k_384_ema.pt",
        hf_hub_id='timm/convnextv2_base.fcmae_ft_in22k_in1k_384',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, crop_mode='squash'),
    'asea_convnextv2_large.fcmae_ft_in22k_in1k': _cfgv2(
        ...
        test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnextv2_large.fcmae_ft_in22k_in1k_384': _cfgv2(
        url="https://dl.fbaipublicfiles.com/convnext/convnextv2/im22k/convnextv2_large_22k_384_ema.pt",
        hf_hub_id='timm/convnextv2_large.fcmae_ft_in22k_in1k_384',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, crop_mode='squash'),
    'asea_convnextv2_huge.fcmae_ft_in22k_in1k_384': _cfgv2(
        url="https://dl.fbaipublicfiles.com/convnext/convnextv2/im22k/convnextv2_huge_22k_384_ema.pt",
        hf_hub_id='timm/convnextv2_huge.fcmae_ft_in22k_in1k_384',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, crop_mode='squash'),
    'asea_convnextv2_huge.fcmae_ft_in22k_in1k_512': _cfgv2(
        url="https://dl.fbaipublicfiles.com/convnext/convnextv2/im22k/convnextv2_huge_22k_512_ema.pt",
        hf_hub_id='timm/convnextv2_huge.fcmae_ft_in22k_in1k_512',
        input_size=(3, 512, 512), pool_size=(15, 15), crop_pct=1.0, crop_mode='squash'),

    'asea_convnextv2_atto.fcmae_ft_in1k': _cfgv2(
        ...
        test_input_size=(3, 288, 288), test_crop_pct=0.95),
    'asea_convnextv2_femto.fcmae_ft_in1k': _cfgv2(
        url='https://dl.fbaipublicfiles.com/convnext/convnextv2/im1k/convnextv2_femto_1k_224_ema.pt',
        hf_hub_id='timm/convnextv2_femto.fcmae_ft_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=0.95),
    'asea_convnextv2_pico.fcmae_ft_in1k': _cfgv2(
        url='https://dl.fbaipublicfiles.com/convnext/convnextv2/im1k/convnextv2_pico_1k_224_ema.pt',
        hf_hub_id='timm/convnextv2_pico.fcmae_ft_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=0.95),
    'asea_convnextv2_nano.fcmae_ft_in1k': _cfgv2(
        url='https://dl.fbaipublicfiles.com/convnext/convnextv2/im1k/convnextv2_nano_1k_224_ema.pt',
        hf_hub_id='timm/convnextv2_nano.fcmae_ft_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnextv2_tiny.fcmae_ft_in1k': _cfgv2(
        url="https://dl.fbaipublicfiles.com/convnext/convnextv2/im1k/convnextv2_tiny_1k_224_ema.pt",
        hf_hub_id='timm/convnextv2_tiny.fcmae_ft_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnextv2_base.fcmae_ft_in1k': _cfgv2(
        url="https://dl.fbaipublicfiles.com/convnext/convnextv2/im1k/convnextv2_base_1k_224_ema.pt",
        hf_hub_id='timm/convnextv2_base.fcmae_ft_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnextv2_large.fcmae_ft_in1k': _cfgv2(
        url="https://dl.fbaipublicfiles.com/convnext/convnextv2/im1k/convnextv2_large_1k_224_ema.pt",
        hf_hub_id='timm/convnextv2_large.fcmae_ft_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'asea_convnextv2_huge.fcmae_ft_in1k': _cfgv2(
        url="https://dl.fbaipublicfiles.com/convnext/convnextv2/im1k/convnextv2_huge_1k_224_ema.pt",
        hf_hub_id='timm/convnextv2_huge.fcmae_ft_in1k',
        test_input_size=(3, 288, 288), test_crop_pct=1.0),

    'asea_convnextv2_atto.fcmae': _cfgv2(
    ...
    'asea_convnextv2_tiny.fcmae': _cfgv2(
        ...
        num_classes=0),
    'asea_convnextv2_base.fcmae': _cfgv2(
        url="https://dl.fbaipublicfiles.com/convnext/convnextv2/pt_only/convnextv2_base_1k_224_fcmae.pt",
        hf_hub_id='timm/convnextv2_base.fcmae',
        num_classes=0),
    'asea_convnextv2_large.fcmae': _cfgv2(
        url="https://dl.fbaipublicfiles.com/convnext/convnextv2/pt_only/convnextv2_large_1k_224_fcmae.pt",
        hf_hub_id='timm/convnextv2_large.fcmae',
        num_classes=0),
    'asea_convnextv2_huge.fcmae': _cfgv2(
        url="https://dl.fbaipublicfiles.com/convnext/convnextv2/pt_only/convnextv2_huge_1k_224_fcmae.pt",
        hf_hub_id='timm/convnextv2_huge.fcmae',
        num_classes=0),

    'asea_convnextv2_small.untrained': _cfg(),

    # CLIP weights, fine-tuned on in1k or in12k + in1k
    'asea_convnext_base.clip_laion2b_augreg_ft_in12k_in1k': _cfg(
        hf_hub_id='timm/convnext_base.clip_laion2b_augreg_ft_in12k_in1k',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 256, 256), pool_size=(8, 8), crop_pct=1.0),
    'asea_convnext_base.clip_laion2b_augreg_ft_in12k_in1k_384': _cfg(
        hf_hub_id='timm/convnext_base.clip_laion2b_augreg_ft_in12k_in1k_384',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, crop_mode='squash'),
    'asea_convnext_large_mlp.clip_laion2b_soup_ft_in12k_in1k_320': _cfg(
        hf_hub_id='timm/convnext_large_mlp.clip_laion2b_soup_ft_in12k_in1k_320',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 320, 320), pool_size=(10, 10), crop_pct=1.0),
    'asea_convnext_large_mlp.clip_laion2b_soup_ft_in12k_in1k_384': _cfg(
        hf_hub_id='timm/convnext_large_mlp.clip_laion2b_soup_ft_in12k_in1k_384',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, crop_mode='squash'),

    'asea_convnext_base.clip_laion2b_augreg_ft_in1k': _cfg(
        hf_hub_id='timm/convnext_base.clip_laion2b_augreg_ft_in1k',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 256, 256), pool_size=(8, 8), crop_pct=1.0),
    'asea_convnext_base.clip_laiona_augreg_ft_in1k_384': _cfg(
        hf_hub_id='timm/convnext_base.clip_laiona_augreg_ft_in1k_384',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0),
    'asea_convnext_large_mlp.clip_laion2b_augreg_ft_in1k': _cfg(
        hf_hub_id='timm/convnext_large_mlp.clip_laion2b_augreg_ft_in1k',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 256, 256), pool_size=(8, 8), crop_pct=1.0
    ),
    'asea_convnext_large_mlp.clip_laion2b_augreg_ft_in1k_384': _cfg(
        hf_hub_id='timm/convnext_large_mlp.clip_laion2b_augreg_ft_in1k_384',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, crop_mode='squash'
    ),
    'asea_convnext_xxlarge.clip_laion2b_soup_ft_in1k': _cfg(
        hf_hub_id='timm/convnext_xxlarge.clip_laion2b_soup_ft_in1k',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 256, 256), pool_size=(8, 8), crop_pct=1.0),

    'asea_convnext_base.clip_laion2b_augreg_ft_in12k': _cfg(
        hf_hub_id='timm/convnext_base.clip_laion2b_augreg_ft_in12k',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, num_classes=11821,
        input_size=(3, 256, 256), pool_size=(8, 8), crop_pct=1.0),
    'asea_convnext_large_mlp.clip_laion2b_soup_ft_in12k_320': _cfg(
        hf_hub_id='timm/convnext_large_mlp.clip_laion2b_soup_ft_in12k_320',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, num_classes=11821,
        input_size=(3, 320, 320), pool_size=(10, 10), crop_pct=1.0),
    'asea_convnext_large_mlp.clip_laion2b_augreg_ft_in12k_384': _cfg(
        hf_hub_id='timm/convnext_large_mlp.clip_laion2b_augreg_ft_in12k_384',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, num_classes=11821,
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, crop_mode='squash'),
    'asea_convnext_large_mlp.clip_laion2b_soup_ft_in12k_384': _cfg(
        hf_hub_id='timm/convnext_large_mlp.clip_laion2b_soup_ft_in12k_384',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, num_classes=11821,
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, crop_mode='squash'),
    'asea_convnext_xxlarge.clip_laion2b_soup_ft_in12k': _cfg(
        hf_hub_id='timm/convnext_xxlarge.clip_laion2b_soup_ft_in12k',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, num_classes=11821,
        input_size=(3, 256, 256), pool_size=(8, 8), crop_pct=1.0),

    # CLIP original image tower weights
    'asea_convnext_base.clip_laion2b': _cfg(
        hf_hub_id='timm/convnext_base.clip_laion2b',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 256, 256), pool_size=(8, 8), crop_pct=1.0, num_classes=640),
    'asea_convnext_base.clip_laion2b_augreg': _cfg(
        hf_hub_id='timm/convnext_base.clip_laion2b_augreg',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 256, 256), pool_size=(8, 8), crop_pct=1.0, num_classes=640),
    'asea_convnext_base.clip_laiona': _cfg(
        hf_hub_id='timm/convnext_base.clip_laiona',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 256, 256), pool_size=(8, 8), crop_pct=1.0, num_classes=640),
    'asea_convnext_base.clip_laiona_320': _cfg(
        hf_hub_id='timm/convnext_base.clip_laiona_320',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 320, 320), pool_size=(10, 10), crop_pct=1.0, num_classes=640),
    'asea_convnext_base.clip_laiona_augreg_320': _cfg(
        hf_hub_id='timm/onvnext_base.clip_laiona_augreg_320',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 320, 320), pool_size=(10, 10), crop_pct=1.0, num_classes=640),
    'asea_convnext_large_mlp.clip_laion2b_augreg': _cfg(
        hf_hub_id='timm/convnext_large_mlp.clip_laion2b_augreg',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 256, 256), pool_size=(8, 8), crop_pct=1.0, num_classes=768),
    'asea_convnext_large_mlp.clip_laion2b_ft_320': _cfg(
        hf_hub_id='timm/convnext_large_mlp.clip_laion2b_ft_320',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 320, 320), pool_size=(10, 10), crop_pct=1.0, num_classes=768),
    'asea_convnext_large_mlp.clip_laion2b_ft_soup_320': _cfg(
        hf_hub_id='timm/convnext_large_mlp.clip_laion2b_ft_soup_320',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 320, 320), pool_size=(10, 10), crop_pct=1.0, num_classes=768),
    'asea_convnext_xxlarge.clip_laion2b_soup': _cfg(
        hf_hub_id='timm/convnext_xxlarge.clip_laion2b_soup',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 256, 256), pool_size=(8, 8), crop_pct=1.0, num_classes=1024),
    'asea_convnext_xxlarge.clip_laion2b_rewind': _cfg(
        hf_hub_id='timm/convnext_xxlarge.clip_laion2b_rewind',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 256, 256), pool_size=(8, 8), crop_pct=1.0, num_classes=1024),

    "test_convnext.r160_in1k": _cfg(
        hf_hub_id='timm/test_convnext.r160_in1k',
        mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
        input_size=(3, 160, 160), pool_size=(5, 5), crop_pct=0.95),
    "test_convnext2.r160_in1k": _cfg(
        hf_hub_id='timm/test_convnext2.r160_in1k',
        mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
        input_size=(3, 160, 160), pool_size=(5, 5), crop_pct=0.95),
    "test_convnext3.r160_in1k": _cfg(
        hf_hub_id='timm/test_convnext3.r160_in1k',
        mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
        input_size=(3, 160, 160), pool_size=(5, 5), crop_pct=0.95),
...
@register_model
def asea_convnext_atto(pretrained=False, **kwargs) -> AseaConvNeXt:
    # timm femto variant (NOTE: still tweaking depths, will vary between 3-4M param, current is 3.7M
    model_args = dict(depths=(2, 2, 6, 2), dims=(40, 80, 160, 320), conv_mlp=True)
    model = _create_convnext('asea_convnext_atto', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnext_atto_ols(pretrained=False, **kwargs) -> AseaConvNeXt:
    ...
    model = _create_convnext('asea_convnext_atto_ols', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnext_femto(pretrained=False, **kwargs) -> AseaConvNeXt:
    # timm femto variant
    model_args = dict(depths=(2, 2, 6, 2), dims=(48, 96, 192, 384), conv_mlp=True)
    model = _create_convnext('asea_convnext_femto', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnext_femto_ols(pretrained=False, **kwargs) -> AseaConvNeXt:
    # timm femto variant
    model_args = dict(depths=(2, 2, 6, 2), dims=(48, 96, 192, 384), conv_mlp=True, stem_type='overlap_tiered')
    model = _create_convnext('asea_convnext_femto_ols', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnext_pico(pretrained=False, **kwargs) -> AseaConvNeXt:
    # timm pico variant
    model_args = dict(depths=(2, 2, 6, 2), dims=(64, 128, 256, 512), conv_mlp=True)
    model = _create_convnext('asea_convnext_pico', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnext_pico_ols(pretrained=False, **kwargs) -> AseaConvNeXt:
    ...
    model = _create_convnext('asea_convnext_pico_ols', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnext_nano(pretrained=False, **kwargs) -> AseaConvNeXt:
    # timm nano variant with standard stem and head
    model_args = dict(depths=(2, 2, 8, 2), dims=(80, 160, 320, 640), conv_mlp=True)
    model = _create_convnext('asea_convnext_nano', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnext_nano_ols(pretrained=False, **kwargs) -> AseaConvNeXt:
    ...
    model = _create_convnext('asea_convnext_nano_ols', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnext_tiny_hnf(pretrained=False, **kwargs) -> AseaConvNeXt:
    ...
    model = _create_convnext('asea_convnext_tiny_hnf', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnext_tiny(pretrained=False, **kwargs) -> AseaConvNeXt:
    model_args = dict(depths=(3, 3, 9, 3), dims=(96, 192, 384, 768))
    model = _create_convnext('asea_convnext_tiny', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnext_small(pretrained=False, **kwargs) -> AseaConvNeXt:
    model_args = dict(depths=[3, 3, 27, 3], dims=[96, 192, 384, 768])
    model = _create_convnext('asea_convnext_small', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnext_base(pretrained=False, **kwargs) -> AseaConvNeXt:
    model_args = dict(depths=[3, 3, 27, 3], dims=[128, 256, 512, 1024])
    model = _create_convnext('asea_convnext_base', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnext_large(pretrained=False, **kwargs) -> AseaConvNeXt:
    model_args = dict(depths=[3, 3, 27, 3], dims=[192, 384, 768, 1536])
    model = _create_convnext('asea_convnext_large', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnext_large_mlp(pretrained=False, **kwargs) -> AseaConvNeXt:
    model_args = dict(depths=[3, 3, 27, 3], dims=[192, 384, 768, 1536], head_hidden_size=1536)
    model = _create_convnext('asea_convnext_large_mlp', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnext_xlarge(pretrained=False, **kwargs) -> AseaConvNeXt:
    model_args = dict(depths=[3, 3, 27, 3], dims=[256, 512, 1024, 2048])
    model = _create_convnext('asea_convnext_xlarge', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnext_xxlarge(pretrained=False, **kwargs) -> AseaConvNeXt:
    model_args = dict(depths=[3, 4, 30, 3], dims=[384, 768, 1536, 3072], norm_eps=kwargs.pop('norm_eps', 1e-5))
    model = _create_convnext('asea_convnext_xxlarge', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnextv2_atto(pretrained=False, **kwargs) -> AseaConvNeXt:
    # timm femto variant (NOTE: still tweaking depths, will vary between 3-4M param, current is 3.7M
    model_args = dict(
        depths=(2, 2, 6, 2), dims=(40, 80, 160, 320), use_grn=True, ls_init_value=None, conv_mlp=True)
    model = _create_convnext('asea_convnextv2_atto', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnextv2_femto(pretrained=False, **kwargs) -> AseaConvNeXt:
    # timm femto variant
    model_args = dict(
        depths=(2, 2, 6, 2), dims=(48, 96, 192, 384), use_grn=True, ls_init_value=None, conv_mlp=True)
    model = _create_convnext('asea_convnextv2_femto', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnextv2_pico(pretrained=False, **kwargs) -> AseaConvNeXt:
    # timm pico variant
    model_args = dict(
        depths=(2, 2, 6, 2), dims=(64, 128, 256, 512), use_grn=True, ls_init_value=None, conv_mlp=True)
    model = _create_convnext('asea_convnextv2_pico', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnextv2_nano(pretrained=False, **kwargs) -> AseaConvNeXt:
    # timm nano variant with standard stem and head
    model_args = dict(
        depths=(2, 2, 8, 2), dims=(80, 160, 320, 640), use_grn=True, ls_init_value=None, conv_mlp=True)
    model = _create_convnext('asea_convnextv2_nano', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnextv2_tiny(pretrained=False, **kwargs) -> AseaConvNeXt:
    model_args = dict(depths=(3, 3, 9, 3), dims=(96, 192, 384, 768), use_grn=True, ls_init_value=None)
    model = _create_convnext('asea_convnextv2_tiny', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnextv2_small(pretrained=False, **kwargs) -> AseaConvNeXt:
    model_args = dict(depths=[3, 3, 27, 3], dims=[96, 192, 384, 768], use_grn=True, ls_init_value=None)
    model = _create_convnext('asea_convnextv2_small', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnextv2_base(pretrained=False, **kwargs) -> AseaConvNeXt:
    model_args = dict(depths=[3, 3, 27, 3], dims=[128, 256, 512, 1024], use_grn=True, ls_init_value=None)
    model = _create_convnext('asea_convnextv2_base', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnextv2_large(pretrained=False, **kwargs) -> AseaConvNeXt:
    model_args = dict(depths=[3, 3, 27, 3], dims=[192, 384, 768, 1536], use_grn=True, ls_init_value=None)
    model = _create_convnext('asea_convnextv2_large', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def asea_convnextv2_huge(pretrained=False, **kwargs) -> AseaConvNeXt:
    model_args = dict(depths=[3, 3, 27, 3], dims=[352, 704, 1408, 2816], use_grn=True, ls_init_value=None)
    model = _create_convnext('asea_convnextv2_huge', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def test_convnext(pretrained=False, **kwargs) -> AseaConvNeXt:
...
@register_model
def test_convnext2(pretrained=False, **kwargs) -> AseaConvNeXt:
...
@register_model
def test_convnext3(pretrained=False, **kwargs) -> AseaConvNeXt:
    model_args = dict(
